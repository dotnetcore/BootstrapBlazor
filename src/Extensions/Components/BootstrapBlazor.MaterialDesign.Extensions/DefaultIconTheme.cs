...
internal class DefaultIconTheme : IIconTheme
{
    ...
    public DefaultIconTheme()
    {
        Icons = new Dictionary<ComponentIcons, string>()
        {
            ...
            { ComponentIcons.FullScreenButtonIcon, "mdi mdi-window-maximize" },
            ...
            { ComponentIcons.PopConfirmButtonConfirmIcon, "mdi mdi-exclamation text-info" },
            { ComponentIcons.PopConfirmButtonContentIcon, "mdi mdi-exclamation text-info" },
            ...
            { ComponentIcons.ToastInformationIcon, "mdi mdi-exclamation text-info" },
            { ComponentIcons.ToastWarningIcon, "mdi mdi-exclamation text-warning" },
