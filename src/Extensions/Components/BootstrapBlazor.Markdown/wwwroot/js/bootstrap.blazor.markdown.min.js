...
(function(n){n.extend({bb_markdown:function(t,i,r,u){var f=n(t);if(i==="init"&&f.toastuiEditor(r),i==="get")return f.toastuiEditor(r);i==="set"&&f.toastuiEditor(r,u)}})})(jQuery);