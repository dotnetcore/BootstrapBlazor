...
/// <summary>
///  <para lang="zh">Interface for theme provider</para>
///  <para lang="en">Interface for theme provider</para>
/// </summary>
public interface IThemeProvider
{
    ...
    /// <summary>
    ///  <para lang="zh">回调 when theme changed</para>
    ///  <para lang="en">The callback when theme changed</para>
    /// </summary>
    Func<string, Task>? ThemeChangedAsync { get; set; }

    /// <summary>
    ///  <para lang="zh">Trigger the theme changed event</para>
    ///  <para lang="en">Trigger the theme changed event</para>
    /// </summary>
    /// <param name="themeName">The name of the theme to set.</param>
