...
public class IpLocatorOptions
{
    ...
    /// <para lang="en">Gets or sets Locator Name, built-in support for BaiduIpLocatorProvider, BaiduIpLocatorProviderV2</para>
    /// </summary>
    public string? ProviderName { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 是否开启缓存降低请求频率 默认 true 缓存</para>
    /// <para lang="en">Gets or sets Enable Cache to reduce request frequency, default true</para>
    /// </summary>
    public bool EnableCache { get; set; } = true;

    /// <summary>
    /// <para lang="zh">获得/设置 滑动过期时间 默认 5 分钟</para>
    /// <para lang="en">Gets or sets Sliding Expiration, default 5 minutes</para>
    /// </summary>
