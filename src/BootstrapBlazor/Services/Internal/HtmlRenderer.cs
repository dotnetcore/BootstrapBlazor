...
/// <summary>
/// <para lang="zh">Provides a mechanism for rendering components non-interactively as HTML markup.
///</para>
/// <para lang="en">Provides a mechanism for rendering components non-interactively as HTML markup.
///</para>
/// </summary>
...
sealed class HtmlRenderer : IDisposable, IAsyncDisposable
{
    ...
    /// <summary>
    /// <para lang="zh">Constructs an 实例 of <see cref="HtmlRenderer"/>.
    ///</para>
    /// <para lang="en">Constructs an instance of <see cref="HtmlRenderer"/>.
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">获得 the <see cref="Components.Dispatcher" /> associated with this 实例. Any calls to
    ...
    ///</para>
    /// <para lang="en">Gets the <see cref="Components.Dispatcher" /> associated with this instance. Any calls to
    /// <see cref="RenderComponentAsync{TComponent}()"/> or <see cref="BeginRenderingComponent{TComponent}()"/>
    /// must be performed using this <see cref="Components.Dispatcher" />.
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">Adds an 实例 of the specified component and instructs it to render. resulting 内容 represents the
    ...
    /// reading 内容 from the <see cref="HtmlRootComponent"/>.
    ///</para>
    /// <para lang="en">Adds an instance of the specified component and instructs it to render. The resulting content represents the
    /// initial synchronous rendering output, which may later change. To wait for the component hierarchy to complete
    /// any asynchronous operations such as loading, await <see cref="HtmlRootComponent.QuiescenceTask"/> before
    ...
    /// <summary>
    /// <para lang="zh">Adds an 实例 of the specified component and instructs it to render, waiting
    /// for the component hierarchy to complete asynchronous tasks such as loading.
    ///</para>
    /// <para lang="en">Adds an instance of the specified component and instructs it to render, waiting
    /// for the component hierarchy to complete asynchronous tasks such as loading.
    ///</para>
    /// </summary>
    /// <typeparam name="TComponent">The component type.</typeparam>
