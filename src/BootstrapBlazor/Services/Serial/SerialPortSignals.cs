...
{
    /// <summary>
    /// <para lang="zh">振铃提示 RI（Ring Indicator）
    /// 如果 RI 为 true，则表示已检测到振铃。如果 RI 为 false，则表示未检测到振铃。Pin 9
    ///</para>
    /// <para lang="en">振铃提示 RI（Ring Indicator）
    /// 如果 RI 为 true，则表示已检测到振铃。如果 RI 为 false，则表示未检测到振铃。Pin 9
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">数据准备就绪 DSR（Data Set Ready）
    /// 如果 DSR 为 true，则表示已准备好接收数据。如果 DSR 为 false，则表示未准备好接收数据。Pin 6
    ///</para>
    /// <para lang="en">data准备就绪 DSR（Data Set Ready）
    /// 如果 DSR 为 true，则表示已准备好接收data。如果 DSR 为 false，则表示未准备好接收data。Pin 6
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">清除发送 CTS（Clear To Send）
    /// 如果 CTS 为 true，则表示已准备好发送数据。如果 CTS 为 false，则表示未准备好发送数据。Pin 8
    ///</para>
    /// <para lang="en">清除发送 CTS（Clear To Send）
    /// 如果 CTS 为 true，则表示已准备好发送data。如果 CTS 为 false，则表示未准备好发送data。Pin 8
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">载波检测 DCD（Data Carrier Detect）
    /// 如果 DCD 为 true，则表示已检测到载波。如果 DCD 为 false，则表示未检测到载波。Pin 1
    ///</para>
    /// <para lang="en">载波检测 DCD（Data Carrier Detect）
    /// 如果 DCD 为 true，则表示已检测到载波。如果 DCD 为 false，则表示未检测到载波。Pin 1
    ///</para>
    /// </summary>
