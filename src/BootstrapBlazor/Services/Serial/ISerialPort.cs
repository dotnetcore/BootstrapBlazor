...
/// <summary>
/// <para lang="zh">ISerialPort 接口
///</para>
/// <para lang="en">ISerialPort 接口
///</para>
/// </summary>
public interface ISerialPort : IAsyncDisposable
{
    /// <summary>
    /// <para lang="zh">获得 端口是否打开
    ///</para>
    /// <para lang="en">Gets 端口whether打开
    ///</para>
    /// </summary>
    bool IsOpen { get; }
    ...
    /// <summary>
    /// <para lang="zh">接收数据回调方法
    ///</para>
    /// <para lang="en">接收datacallback method
    ///</para>
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// <para lang="zh">获得 Usb 设备信息
    ///</para>
    /// <para lang="en">Gets Usb 设备信息
    ///</para>
    /// </summary>
