...
{
    /// <summary>
    /// <para lang="zh">获得首字母拼音方法
    ///</para>
    /// <para lang="en">Gets首字母拼音方法
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">获得完整拼音方法
    ///</para>
    /// <para lang="en">Gets完整拼音方法
    ///</para>
    /// </summary>
    /// <param name="text"></param>
    /// <param name="caseCategory"></param>
    ...
    /// <summary>
    /// <para lang="zh">判断是否为中文字符
    ///</para>
    /// <para lang="en">判断whether为中文字符
    ///</para>
    /// </summary>
    /// <param name="c"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// <para lang="zh">判断字符串是否包含中文字符
    ///</para>
    /// <para lang="en">判断字符串whether包含中文字符
    ///</para>
    /// </summary>
    /// <param name="text"></param>
    /// <returns></returns>
