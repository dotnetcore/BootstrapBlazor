...
/// <summary>
/// <para lang="zh">动态类型实体类 <see cref="IDynamicObject" /> 实例
///</para>
/// <para lang="en">动态type实体类 <see cref="IDynamicObject" /> instance
///</para>
/// </summary>
public class DynamicObject : IDynamicObject
{
    ...
    /// <summary>
    /// <para lang="zh">获得指定属性值方法
    ///</para>
    /// <para lang="en">Gets指定property值方法
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">给指定属性设置值方法
    ///</para>
    /// <para lang="en">给指定propertySets值方法
    ///</para>
    /// </summary>
    /// <param name="propertyName"></param>
