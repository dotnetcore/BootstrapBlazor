...
/// <summary>
/// <para lang="zh">DynamicObjectContextArgs 类
///</para>
/// <para lang="en">DynamicObjectContextArgs 类
///</para>
/// </summary>
public class DynamicObjectContextArgs
{
    ...
    /// <summary>
    /// <para lang="zh">获得 编辑数据集合
    ///</para>
    /// <para lang="en">Gets 编辑datacollection
    ///</para>
    /// </summary>
    public IEnumerable<IDynamicObject> Items { get; }

    /// <summary>
    /// <para lang="zh">获得 数据改变类型 默认 Add
    ///</para>
    /// <para lang="en">Gets data改变type Default is Add
    ///</para>
    /// </summary>
