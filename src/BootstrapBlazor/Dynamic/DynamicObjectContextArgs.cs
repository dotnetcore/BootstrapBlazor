...
/// <summary>
/// <para lang="zh">DynamicObjectContextArgs 上下文参数类</para>
/// <para lang="en">DynamicObjectContextArgs context parameter class</para>
/// </summary>
public class DynamicObjectContextArgs
{
    ...
    /// <para lang="en">Gets the collection of edited data</para>
    /// </summary>
    public IEnumerable<IDynamicObject> Items { get; }

    /// <summary>
    /// <para lang="zh">获得 数据改变类型 默认 Add</para>
    /// <para lang="en">Gets the type of data change. Default is Add</para>
    /// </summary>
