...
/// <summary>
/// <para lang="zh">动态类型上下文基类 <see cref="IDynamicObjectContext" />
///</para>
/// <para lang="en">动态type上下文基类 <see cref="IDynamicObjectContext" />
///</para>
/// </summary>
public abstract class DynamicObjectContext : IDynamicObjectContext
{
    /// <summary>
    /// <para lang="zh">获取动态类型各列信息
    ///</para>
    /// <para lang="en">获取动态type各列信息
    ///</para>
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// <para lang="zh">获得动态类数据方法
    ///</para>
    /// <para lang="en">Gets动态类data方法
    ///</para>
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// <para lang="zh">添加标签到指定列
    ///</para>
    /// <para lang="en">添加标签到指定列
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">列创建回调方法 入口参数为 ITableColumn 实例 返回值为 CustomAttributeBuilder 集合
    ///</para>
    /// <para lang="en">列创建callback method 入口参数为 ITableColumn instance 返回值为 CustomAttributeBuilder collection
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">动态类型新建回调委托
    ///</para>
    /// <para lang="en">动态type新建回调delegate
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">动态类型删除回调委托
    ///</para>
    /// <para lang="en">动态type删除回调delegate
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">动态类型集合变化时回调方法
    ///</para>
    /// <para lang="en">动态typecollection变化时callback method
    ///</para>
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// <para lang="zh">动态类型属性值变化时回调方法
    ///</para>
    /// <para lang="en">动态typeproperty值变化时callback method
    ///</para>
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// <para lang="zh">获得选中行比对回调方法
    ///</para>
    /// <para lang="en">Gets选中行比对callback method
    ///</para>
    /// </summary>
