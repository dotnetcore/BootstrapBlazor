...
public static class JSModuleExtensions
{
    ...
    /// <summary>
    /// <para lang="zh">IJSRuntime 扩展方法，用于动态加载脚本</para>
    ...
    /// <summary>
    /// <para lang="zh">在新标签页中打开指定的 URL</para>
    ...
    /// <summary>
    /// <para lang="zh">动态运行 JavaScript 代码</para>
    ...
    /// <summary>
    /// <para lang="zh">通过 Eval 动态运行 JavaScript 代码</para>
    ...
    /// <summary>
    /// <para lang="zh">通过 Function 动态运行 JavaScript 代码</para>
    ...
    /// <summary>
    /// <para lang="zh">检查当前终端是否为移动设备</para>
    ...
    /// <summary>
    /// <para lang="zh">获取页面上唯一的元素 ID</para>
    ...
    /// <summary>
    /// <para lang="zh">获取页面上指定元素的 HTML 字符串</para>
