...
public class PdfOptions
{
    ...
    /// <para lang="en">Gets or sets whether to print landscape default false</para>
    /// </summary>
    public bool Landscape { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 是否打印背景色 默认 false</para>
    /// <para lang="en">Gets or sets whether to print background default false</para>
    /// </summary>
    public bool PrintBackground { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 纸张格式 默认 A4</para>
    /// <para lang="en">Gets or sets paper format default A4</para>
    /// </summary>
    public PaperFormat Format { get; set; } = PaperFormat.A4;

    /// <summary>
    /// <para lang="zh">获得/设置 是否显示页眉页脚 默认 false</para>
    /// <para lang="en">Gets or sets whether to display header and footer default false</para>
    /// </summary>
    public bool DisplayHeaderFooter { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 放大比例 默认 1 取值 0.1 到 2 之间</para>
    /// <para lang="en">Gets or sets scale default 1 between 0.1 and 2</para>
    /// </summary>
    public decimal Scale { get; set; } = 1;

    /// <summary>
    /// <para lang="zh">获得/设置 页面边距 默认 未设置</para>
    /// <para lang="en">Gets or sets page margin default not set</para>
    /// </summary>
