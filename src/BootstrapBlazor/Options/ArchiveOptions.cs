...
public class ArchiveOptions
{
    ...
    /// <para lang="en">Gets or sets compression level default <see cref="CompressionLevel.Optimal"/></para>
    /// </summary>
    public CompressionLevel CompressionLevel { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 归档模式 默认 <see cref="ZipArchiveMode.Create"/></para>
    /// <para lang="en">Gets or sets archive mode default <see cref="ZipArchiveMode.Create"/></para>
    /// </summary>
    public ZipArchiveMode Mode { get; set; } = ZipArchiveMode.Create;

    /// <summary>
    /// <para lang="zh">获得/设置 归档结束后是否关闭流 默认 false 归档后关闭相关流</para>
    /// <para lang="en">Gets or sets whether to leave the stream open after the archive is finished default false</para>
    /// </summary>
    internal bool LeaveOpen { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 编码方法 默认空 内部使用 UTF-8 编码</para>
    /// <para lang="en">Gets or sets encoding default null using UTF-8 internally</para>
    /// </summary>
    public Encoding? Encoding { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 获取文件流回调方法</para>
    /// <para lang="en">Gets or sets get file stream callback method</para>
    /// </summary>
