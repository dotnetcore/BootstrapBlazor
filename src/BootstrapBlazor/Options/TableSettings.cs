...
public class TableSettings
{
    ...
    /// <para lang="en">Get/Set checkbox column compact width default 28</para>
    /// </summary>
    ...
    /// <para lang="en">Get/Set column min width default 64</para>
    /// </summary>
    public int ColumnMinWidth { get; set; } = 64;

    /// <summary>
    /// <para lang="zh">获得/设置 表格渲染模式</para>
    /// <para lang="en">Get/Set table render mode</para>
    /// </summary>
    public TableRenderMode? TableRenderMode { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 TableExportExcelOptions 配置 默认为不为空</para>
    /// <para lang="en">Get/Set TableExportExcelOptions configuration default not null</para>
    /// </summary>
