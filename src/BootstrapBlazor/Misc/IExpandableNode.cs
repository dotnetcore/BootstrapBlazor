...
public interface IExpandableNode<TItem>
{
    ...
    /// <para lang="en">Gets or sets whether expand default false</para>
    /// </summary>
    public bool IsExpand { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 是否有子节点 默认 false 用于判断是否有子节点</para>
    /// <para lang="en">Gets or sets whether has children default false used to determine whether there are children</para>
    /// </summary>
    public bool HasChildren { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 子节点</para>
    /// <para lang="en">Gets or sets children</para>
    /// </summary>
    [DisallowNull]
    [NotNull]
    ...
    /// <para lang="en">Gets or sets TItem generic value</para>
    /// </summary>
    [DisallowNull]
    [NotNull]
    TItem? Value { get; set; }
