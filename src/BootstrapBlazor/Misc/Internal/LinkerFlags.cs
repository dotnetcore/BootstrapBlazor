...
{
    /// <summary>
    /// <para lang="zh">Flags for a member that is JSON (de)serialized.
    ///</para>
    /// <para lang="en">Flags for a member that is JSON (de)serialized.
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">Flags for a component
    ///</para>
    /// <para lang="en">Flags for a component
    ///</para>
    /// </summary>
