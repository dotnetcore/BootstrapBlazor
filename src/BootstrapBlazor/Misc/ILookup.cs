...
public interface ILookup
{
    ...
    /// <para lang="en">Get/Set data set for CheckboxList Select component display Text via Value default null</para>
    ...
    /// <para lang="en">Get/Set dictionary data source string comparison rule default <see cref="StringComparison.OrdinalIgnoreCase" /> case insensitive</para>
    /// </summary>
    ...
    /// <para lang="en">Get/Set <see cref="ILookupService"/> service get Lookup data collection key value often used for foreign key automatic conversion to name operation, can pass custom data through <see cref="LookupServiceData"/></para>
    ...
    /// <para lang="en">Get/Set <see cref="ILookupService"/> service get Lookup data collection key value custom data, specify key value through <see cref="LookupServiceKey"/></para>
    /// <para lang="zh">未设置 <see cref="Lookup"/> 时生效</para>
    /// <para lang="en">Effective when <see cref="Lookup"/> is not set</para>
    /// </summary>
    ...
    /// <para lang="en">Get/Set <see cref="ILookupService"/> service instance</para>
    /// </summary>
