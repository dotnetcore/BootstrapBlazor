...
internal interface IPopoverBaseComponent
{
    ...
    /// <para lang="en">Gets or sets popover placement default Bottom</para>
    /// </summary>
    Placement Placement { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 自定义样式 参数 默认 null</para>
    /// <para lang="en">Gets or sets custom style parameter default null</para>
    /// </summary>
    ...
    /// <para lang="en">Gets or sets whether show shadow default true</para>
    /// </summary>
