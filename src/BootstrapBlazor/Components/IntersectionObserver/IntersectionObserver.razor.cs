...
/// <summary>
/// <para lang="zh">可见检测组件</para>
/// <para lang="en">可见检测component</para>
/// </summary>
public partial class IntersectionObserver
{
    /// <summary>
    /// <para lang="zh">获得/设置 是否使用元素视口作为根元素 默认为 true 使用当前元素作为根元素 <para>The element that is used as the viewport for checking visibility of the target. Must be the ancestor of the target. Defaults to the browser viewport if value is false. Default value is true</para>
    ///</para>
    /// <para lang="en">Gets or sets whether使用元素视口作为根元素 Default is为 true 使用当前元素作为根元素 <para>The element that is used as the viewport for checking visibility of the target. Must be the ancestor of the target. Defaults to the browser viewport if value is false. Default value is true</para>
    ///</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 可见后是否自动取消观察 默认 true 可见后自动取消观察提高性能</para>
    /// <para lang="en">Gets or sets 可见后whether自动取消观察 Default is true 可见后自动取消观察提高性能</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 不可见后是否自动取消观察 默认 false 不可见后自动取消观察提高性能</para>
    /// <para lang="en">Gets or sets 不可见后whether自动取消观察 Default is false 不可见后自动取消观察提高性能</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 已经交叉回调方法</para>
    /// <para lang="en">Gets or sets 已经交叉callback method</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">交叉检测回调方法 由 JavaScript 调用</para>
    /// <para lang="en">交叉检测callback method 由 JavaScript 调用</para>
    /// </summary>
    /// <param name="entry"><para lang="zh"><see cref="IntersectionObserverEntry"/> 实例</para><para lang="en"><see cref="IntersectionObserverEntry"/> instance</para></param>
    /// <returns></returns>
    [JSInvokable]
