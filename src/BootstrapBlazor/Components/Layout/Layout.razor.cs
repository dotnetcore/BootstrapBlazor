...
public partial class Layout : IHandlerException, ITabHeader
{
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the 模板 of before tab context menu. 默认为 null.
    ///</para>
    /// <para lang="en">Gets or sets the template of before tab context menu. Default is null.
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the 模板 of tab context menu. 默认为 null.
    ///</para>
    /// <para lang="en">Gets or sets the template of tab context menu. Default is null.
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否 show the tab in header. 默认为 false.
    ///</para>
    /// <para lang="en">Gets or sets whether show the tab in header. Default is false.
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
