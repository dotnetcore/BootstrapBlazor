...
/// <summary>
/// <para lang="zh">NavbarToggleButton 组件
///</para>
/// <para lang="en">NavbarToggleButton component
///</para>
/// </summary>
public partial class NavbarToggleButton
{
    /// <summary>
    /// <para lang="zh">获得/设置 联动组件选择器 默认 null
    ///</para>
    /// <para lang="en">Gets or sets 联动component选择器 Default is null
    ///</para>
