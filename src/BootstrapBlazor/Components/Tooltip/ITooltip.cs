...
///  <para lang="en">ITooltip 接口</para>
/// </summary>
public interface ITooltip
{
    /// <summary>
    ///  <para lang="zh">获得/设置 位置</para>
    ///  <para lang="en">Gets or sets 位置</para>
    /// </summary>
    Placement Placement { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 显示内容</para>
    ///  <para lang="en">Gets or sets displaycontent</para>
    /// </summary>
    string? Title { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 内容是否为 Html 默认 false</para>
    ///  <para lang="en">Gets or sets contentwhether为 Html Default is false</para>
    /// </summary>
    bool IsHtml { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 触发方式 可组合 click focus hover manual 默认为 focus hover</para>
    ///  <para lang="en">Gets or sets 触发方式 可组合 click focus hover manual Default is为 focus hover</para>
    /// </summary>
    ...
    ///  <para lang="en">Gets or sets 自定义style Default is null</para>
    /// </summary>
    ...
    ///  <para lang="en">Gets or sets display隐藏延时 Default is null</para>
    /// </summary>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 是否对 <see cref="Title"/> 进行关键字过滤 默认 true</para>
    ///  <para lang="en">Gets or sets whether对 <see cref="Title"/> 进行关键字过滤 Default is true</para>
    /// </summary>
    bool Sanitize { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 元素选择器</para>
    ///  <para lang="en">Gets or sets 元素选择器</para>
    /// </summary>
