...
/// <summary>
/// <para lang="zh">Tooltip 组件
///</para>
/// <para lang="en">Tooltip component
///</para>
/// </summary>
public partial class Tooltip : ITooltip
{
    /// <summary>
    /// <para lang="zh">弹窗位置字符串
    ///</para>
    /// <para lang="en">弹窗位置字符串
    ///</para>
    /// </summary>
    protected string? PlacementString => Placement == Placement.Auto ? null : Placement.ToDescriptionString();

    /// <summary>
    /// <para lang="zh">获得 是否关键字过滤字符串
    ///</para>
    /// <para lang="en">Gets whether关键字过滤字符串
    ///</para>
    /// </summary>
    protected string? SanitizeString => Sanitize ? null : "false";

    /// <summary>
    /// <para lang="zh">获得 是否 Html 字符串
    ///</para>
    /// <para lang="en">Gets whether Html 字符串
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">fallbackPlacements 参数
    ///</para>
    /// <para lang="en">fallbackPlacements 参数
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 获得显示内容异步回调方法 默认 null
    ///</para>
    /// <para lang="en">Gets or sets Getsdisplaycontent异步callback method Default is null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 位置 默认为 null
    ///</para>
    /// <para lang="en">Gets or sets 位置 Default is为 null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 偏移量 默认为 null
    ///</para>
    /// <para lang="en">Gets or sets 偏移量 Default is为 null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">显示 Tooltip 弹窗方法
    ///</para>
    /// <para lang="en">display Tooltip 弹窗方法
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">关闭 Tooltip 弹窗方法
    ///</para>
    /// <para lang="en">关闭 Tooltip 弹窗方法
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">切换 Tooltip 弹窗当前状态方法
    ///</para>
    /// <para lang="en">切换 Tooltip 弹窗当前状态方法
    ///</para>
    /// </summary>
