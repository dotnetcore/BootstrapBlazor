...
public class ConsoleMessageItem
{
    ...
    /// <para lang="en">Gets or sets console output message</para>
    /// </summary>
    [NotNull]
    ...
    /// <para lang="en">Gets or sets console message color, default is White</para>
    /// </summary>
    public Color Color { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 自定义样式名称 默认 null</para>
    /// <para lang="en">Gets or sets custom style name, default is null</para>
    /// </summary>
    public string? CssClass { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 是否为 Html 原生字符串 默认 false</para>
    /// <para lang="en">Gets or sets whether it is Html raw string, default is false</para>
    /// </summary>
