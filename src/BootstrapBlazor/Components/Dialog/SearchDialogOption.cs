...
public class SearchDialogOption<TModel> : DialogOption
{
    ...
    /// <para lang="en">Gets or sets Whether to Show Label. Default is true</para>
    /// </summary>
    ...
    /// <para lang="en">Gets or sets Search Model</para>
    /// </summary>
    ...
    /// <para lang="en">Gets or sets SearchDialog Body Template</para>
    /// </summary>
