...
SortableList Component Interface

Primary source directory: `src/BootstrapBlazor/Components/SortableList`.

Source files reviewed:

- `src/BootstrapBlazor/Components/SortableList/ISortableList.cs`
...
- Direct `<SortableList>` tag usages detected: 17
- Observed attributes in official Sample: `Id`, `OnAdd`, `OnRemove`, `OnUpdate`, `Option`
...
1. Read `src/BootstrapBlazor/Components/SortableList` before generating code.
