...
/// <summary>
/// <para lang="zh">ValidateForm 组件类
///</para>
/// <para lang="en">ValidateForm component类
///</para>
/// </summary>
public partial class ValidateForm
{
    /// <summary>
    /// <para lang="zh">A 回调 that will be invoked when the form is submitted and the
    /// <see cref="EditContext"/> is determined to be valid.
    ///</para>
    /// <para lang="en">A callback that will be invoked when the form is submitted and the
    /// <see cref="EditContext"/> is determined to be valid.
    ///</para>
    ...
    /// <summary>
    /// <para lang="zh">A 回调 that will be invoked when the field's value has been changed
    ///</para>
    /// <para lang="en">A callback that will be invoked when the field's value has been changed
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否显示所有验证失败字段的提示信息 默认 false 仅显示第一个验证失败字段的提示信息
    ///</para>
    /// <para lang="en">Gets or sets whetherdisplay所有验证失败字段的提示信息 Default is false 仅display第一个验证失败字段的提示信息
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否验证所有字段 默认 false
    ///</para>
    /// <para lang="en">Gets or sets whether验证所有字段 Default is false
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">Specifies the top-level model object for the form. An edit context will
    /// be constructed for this model. If using this parameter, do not also supply
    /// a value for <see cref="EditContext"/>.
    ///</para>
    /// <para lang="en">Specifies the top-level model object for the form. An edit context will
    /// be constructed for this model. If using this parameter, do not also supply
    /// a value for <see cref="EditContext"/>.
    ///</para>
    /// <para><version>10.2.2</version></para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否获取必填项标记 默认为 true 显示
    ///</para>
    /// <para lang="en">Gets or sets whether获取必填项标记 Default is为 true display
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否显示验证表单内的 Label 默认为 null
    ///</para>
    /// <para lang="en">Gets or sets whetherdisplay验证表单内的 Label Default is为 null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否显示标签 Tooltip 多用于标签文字过长导致裁减时使用 默认 null
    ///</para>
    /// <para lang="en">Gets or sets whetherdisplay标签 Tooltip 多用于标签文字过长导致裁减时使用 Default is null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否为无表单模式 默认 false
    ///</para>
    /// <para lang="en">Gets or sets whether为无表单模式 Default is false
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">验证组件验证结果缓存
    ///</para>
    /// <para lang="en">验证component验证结果缓存
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">验证合法成员集合
    ///</para>
    /// <para lang="en">验证合法成员collection
    ///</para>
    /// </summary>
    internal List<string> ValidMemberNames { get; } = [];

    /// <summary>
    /// <para lang="zh">验证非法成员集合
    ///</para>
    /// <para lang="en">验证非法成员collection
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">添加数据验证组件到 EditForm 中
    ///</para>
    /// <para lang="en">添加data验证component到 EditForm 中
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">移除数据验证组件到 EditForm 中
    ///</para>
    /// <para lang="en">移除data验证component到 EditForm 中
    ///</para>
    /// </summary>
    /// <param name="key"></param>
    /// <param name="value"></param>
    ...
    /// <summary>
    /// <para lang="zh">设置指定字段错误信息
    ///</para>
    /// <para lang="en">Sets指定字段错误信息
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">EditModel 数据模型验证方法
    ///</para>
    /// <para lang="en">EditModel data模型验证方法
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">通过表单内绑定的字段验证方法
    ///</para>
    /// <para lang="en">通过表单内绑定的字段验证方法
    ///</para>
    /// </summary>
    /// <param name="context"></param>
    /// <param name="results"></param>
    ...
    /// <summary>
    /// <para lang="zh">通过属性设置的 DataAnnotation 进行数据验证
    ///</para>
    /// <para lang="en">通过propertySets的 DataAnnotation 进行data验证
    ///</para>
    /// </summary>
    /// <param name="value"></param>
    /// <param name="context"></param>
    ...
    /// <summary>
    /// <para lang="zh">验证整个模型时验证属性方法
    ///</para>
    /// <para lang="en">验证整个模型时验证property方法
    ///</para>
    /// </summary>
    /// <param name="context"></param>
    /// <param name="results"></param>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 无表单模式下的 EditContext 实例
    ///</para>
    /// <para lang="en">Gets or sets 无表单模式下的 EditContext instance
    ///</para>
    /// </summary>
    private EditContext? _formlessEditContext;

    /// <summary>
    /// <para lang="zh">同步验证方法 用于代码调用触发表单验证（不支持某些组件的异步验证）
    ///</para>
    /// <para lang="en">同步验证方法 用于代码调用触发表单验证（不支持某些component的异步验证）
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">异步验证方法 用于代码调用触发表单验证（支持异步验证）
    ///</para>
    /// <para lang="en">异步验证方法 用于代码调用触发表单验证（支持异步验证）
    ///</para>
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// <para lang="zh">通知属性改变方法
    ///</para>
    /// <para lang="en">通知property改变方法
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">获取 当前表单值改变的属性集合
    ///</para>
    /// <para lang="en">获取 当前表单值改变的propertycollection
    ///</para>
    /// </summary>
    /// <returns></returns>
