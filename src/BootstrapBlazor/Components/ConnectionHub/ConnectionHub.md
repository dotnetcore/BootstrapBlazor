...
Primary source directory: `src/BootstrapBlazor/Components/ConnectionHub`.

Source files reviewed:

- `src/BootstrapBlazor/Components/ConnectionHub/ConnectionHub.cs`
- `src/BootstrapBlazor/Components/ConnectionHub/ConnectionItem.cs`
...
No official Sample was matched for `ConnectionHub`.
...
No direct Razor example is generated because this directory does not expose an authoritative `ConnectionHub.razor` usage pattern in the current repository.
...
1. Read `src/BootstrapBlazor/Components/ConnectionHub` before generating code.
