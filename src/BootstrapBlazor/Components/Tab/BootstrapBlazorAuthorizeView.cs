...
/// <summary>
/// <para lang="zh">BootstrapBlazorAuthorizeView component
///</para>
/// <para lang="en">BootstrapBlazorAuthorizeView component
///</para>
/// </summary>
public class BootstrapBlazorAuthorizeView : ComponentBase
{
    /// <summary>
    /// <para lang="zh">获得/设置 the 类型 associated with the route. default is null
    ///</para>
    /// <para lang="en">Gets or sets the type associated with the route. default is null
    ///</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the parameters associated with the route. default is null
    ///</para>
    /// <para lang="en">Gets or sets the parameters associated with the route. default is null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the 模板 to 显示 when the user is not authorized. default is null
    ///</para>
    /// <para lang="en">Gets or sets the template to display when the user is not authorized. default is null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the resource to which access is being controlled. default is null
    ///</para>
    /// <para lang="en">Gets or sets the resource to which access is being controlled. default is null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
