...
/// <summary>
/// <para lang="zh">Resolves components for an application.</para>
/// <para lang="en">Resolves components for an application.</para>
/// </summary>
