...
/// <summary>
/// <para lang="zh">Resolves components for an application.
///</para>
/// <para lang="en">Resolves components for an application.
///</para>
/// </summary>
...
internal static class RouteTableFactory
{
    ...
    /// <summary>
    /// <para lang="zh">Route precedence algorithm.
    /// We collect all the routes and sort them from most specific to
    /// less specific. specificity of a route is given by the specificity
    ...
    ///</para>
    /// <para lang="en">Route precedence algorithm.
    /// We collect all the routes and sort them from most specific to
