...
/// <summary>
/// <para lang="zh">Shared logic for parsing tokens from route values and querystring values.
///</para>
/// <para lang="en">Shared logic for parsing tokens from route values and querystring values.
///</para>
/// </summary>
