...
/// <summary>
/// <para lang="zh">Represents a link within a tab component.</para>
/// <para lang="en">Represents a link within a tab component.</para>
/// </summary>
public sealed partial class TabLink
{
    /// <summary>
    /// <para lang="zh">获得/设置 the text of the link. 默认为 null</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the URL of the link. 默认为 null</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the 图标 of the link. 默认为 null</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 a value indicating 是否 the tab item is closable. 默认为 true.</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the 回调方法 when the link is clicked. 默认为 null.</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 the 内容 of the component. 默认为 null</para>
