...
/// <summary>
///  <para lang="zh">WebSpeechSynthesisVoice 类</para>
///  <para lang="en">WebSpeechSynthesisVoice 类</para>
/// </summary>
public class WebSpeechSynthesisVoice
{
    /// <summary>
    ///  <para lang="zh">获得/设置 是否为默认</para>
    ///  <para lang="en">Gets or sets whether为Default is</para>
    /// </summary>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 indicating whether the voice is supplied by a local speech synthesizer service</para>
    ///  <para lang="en">Gets or sets indicating whether the voice is supplied by a local speech synthesizer service</para>
    /// </summary>
