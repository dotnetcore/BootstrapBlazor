...
/// <summary>
/// <para lang="zh">CardUpload component
///</para>
/// <para lang="en">CardUpload component
///</para>
/// </summary>
public partial class CardUpload<TValue>
{
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 图标模板
    ///</para>
    /// <para lang="en">Gets or sets icontemplate
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 操作按钮模板
    ///</para>
    /// <para lang="en">Gets or sets 操作buttontemplate
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否显示文件尺寸，默认为 true 显示
    ///</para>
    /// <para lang="en">Gets or sets whetherdisplay文件尺寸，Default is为 true display
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 状态图标
    ///</para>
    /// <para lang="en">Gets or sets 状态icon
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 移除图标
    ///</para>
    /// <para lang="en">Gets or sets 移除icon
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 放大图标
    ///</para>
    /// <para lang="en">Gets or sets 放大icon
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否显示放大按钮 默认 true
    ///</para>
    /// <para lang="en">Gets or sets whetherdisplay放大button Default is true
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否显示删除按钮 默认 true 显示
    ///</para>
    /// <para lang="en">Gets or sets whetherdisplay删除button Default is true display
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 点击 Zoom 图标回调方法
    ///</para>
    /// <para lang="en">Gets or sets 点击 Zoom iconcallback method
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 删除前是否显示确认对话框，依赖 <see cref="FileListUploadBase{TValue}.ShowDeleteButton"/> 属性为 true 时有效
    ///</para>
    /// <para lang="en">Gets or sets 删除前whetherdisplay确认对话框，依赖 <see cref="FileListUploadBase{TValue}.ShowDeleteButton"/> property为 true 时有效
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 删除确认弹窗中确认按钮颜色 默认 <see cref="Color.Danger"/>
    ///</para>
    /// <para lang="en">Gets or sets 删除确认弹窗中确认buttoncolor Default is <see cref="Color.Danger"/>
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 删除确认弹窗中确认按钮图标 默认 null 未设置
    ///</para>
    /// <para lang="en">Gets or sets 删除确认弹窗中确认buttonicon Default is null 未Sets
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 删除确认弹窗中确认文本内容 默认 null 未设置 使用资源文件中内置文字
    ///</para>
    /// <para lang="en">Gets or sets 删除确认弹窗中确认文本content Default is null 未Sets 使用资源文件中内置文字
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 删除确认弹窗中确认按钮显示文字 默认 null 未设置
    ///</para>
    /// <para lang="en">Gets or sets 删除确认弹窗中确认buttondisplay文字 Default is null 未Sets
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 删除确认弹窗中取消按钮显示文字 默认 null 未设置
    ///</para>
    /// <para lang="en">Gets or sets 删除确认弹窗中取消buttondisplay文字 Default is null 未Sets
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
