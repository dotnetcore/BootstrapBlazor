...
/// <summary>
/// <para lang="zh">Toast 弹出窗组件
///</para>
/// <para lang="en">Toast 弹出窗component
///</para>
/// </summary>
public partial class ToastContainer : IDisposable
{
    ...
    /// <summary>
    /// <para lang="zh">获得 弹出窗集合
    ///</para>
    /// <para lang="en">Gets 弹出窗collection
    ///</para>
    /// </summary>
    private List<ToastOption> Toasts { get; } = [];

    /// <summary>
    /// <para lang="zh">获得/设置 显示文字
    ///</para>
    /// <para lang="en">Gets or sets display文字
    ///</para>
    ...
    /// <summary>
    /// <para lang="zh">设置 Toast 容器位置方法
    ///</para>
    /// <para lang="en">Sets Toast 容器位置方法
    ///</para>
    /// </summary>
