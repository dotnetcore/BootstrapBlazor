...
public abstract class PopupOptionBase
{
    ...
    /// <para lang="en">Gets or sets Toast Body Child Component</para>
    /// </summary>
    public string? Content { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 是否自动隐藏 默认 true 自动关闭 <see cref="PopupOptionBase"/> 默认 true</para>
    /// <para lang="en">Gets or sets Whether to auto hide. Default true</para>
    /// </summary>
    public bool IsAutoHide { get; set; } = true;

    /// <summary>
    /// <para lang="zh">获得/设置 自动隐藏时间间隔 单位毫秒 默认 4000 可通过全局配置进行统一更改</para>
    /// <para lang="en">Gets or sets Auto hide interval in milliseconds. Default 4000. Can be configured globally</para>
    /// </summary>
    public int Delay { get; set; } = 4000;

    /// <summary>
    /// <para lang="zh">获得/设置 是否强制使用本实例的延时时间，防止值被全局配置覆盖 默认 false</para>
    /// <para lang="en">Gets or sets Whether to force use the delay time of this instance to prevent the value from being overwritten by global configuration. Default false</para>
