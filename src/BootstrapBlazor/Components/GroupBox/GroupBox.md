...
Primary source directory: `src/BootstrapBlazor/Components/GroupBox`.

Source files reviewed:

- `src/BootstrapBlazor/Components/GroupBox/GroupBox.razor`
- `src/BootstrapBlazor/Components/GroupBox/GroupBox.razor.cs`
...
| `Title` | `string?` | Gets or sets Title Property Default null |
...
- `src/BootstrapBlazor.Server/Components/Samples/GroupBoxes.razor.cs`

Sample analysis:

- Direct `<GroupBox>` tag usages detected: 1
- Observed attributes in official Sample: `Title`
...
1. Read `src/BootstrapBlazor/Components/GroupBox` before generating code.
