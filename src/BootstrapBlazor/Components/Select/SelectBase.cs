...
/// <summary>
///  <para lang="zh">SelectBase component base class</para>
...
public abstract class SelectBase<TValue> : PopoverSelectBase<TValue>
{
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 the search text.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 the <see cref="IIconTheme"/> service 实例.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得 the search 图标 string with default "图标 search-图标" class.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得 the custom class string.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得 the append class string.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得 the clear 图标 class string.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得 the SearchLoadingIcon 图标 class string.</para>
    ...
    /// <summary>
    ///  <para lang="zh">Shows the dropdown.</para>
    ...
    /// <summary>
    ///  <para lang="zh">Hides the dropdown.</para>
    ...
    /// <summary>
    ///  <para lang="zh">Clears the search text.</para>
