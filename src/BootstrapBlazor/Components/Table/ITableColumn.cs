...
/// <summary>
///  <para lang="zh">ITableHeader interface</para>
///  <para lang="en">ITableHeader interface</para>
/// </summary>
public interface ITableColumn : IEditorItem
{
    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the current item is ignored when export operation. 默认为 false.</para>
    ///  <para lang="en">Gets or sets whether the current item is ignored when export operation. Default is false.</para>
    /// </summary>
    bool? IgnoreWhenExport { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 sorting is allowed. 默认为 null.</para>
    ///  <para lang="en">Gets or sets whether sorting is allowed. Default is null.</para>
    /// </summary>
    bool? Sortable { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 it is the default sort column. 默认为 false.</para>
    ///  <para lang="en">Gets or sets whether it is the default sort column. Default is false.</para>
    /// </summary>
    bool DefaultSort { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 the default sort order. 默认为 SortOrder.Unset.</para>
    ///  <para lang="en">Gets or sets the default sort order. Default is SortOrder.Unset.</para>
    /// </summary>
    SortOrder DefaultSortOrder { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 数据 filtering is allowed. 默认为 null.</para>
    ///  <para lang="en">Gets or sets whether data filtering is allowed. Default is null.</para>
    /// </summary>
    bool? Filterable { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the column participates in search. 默认为 null.</para>
    ///  <para lang="en">Gets or sets whether the column participates in search. Default is null.</para>
    /// </summary>
    bool? Searchable { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 the column 宽度.</para>
    ///  <para lang="en">Gets or sets the column width.</para>
    /// </summary>
    int? Width { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the column is fixed. 默认为 false.</para>
    ///  <para lang="en">Gets or sets whether the column is fixed. Default is false.</para>
    /// </summary>
    bool Fixed { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 text wrapping is allowed in this column. 默认为 null.</para>
    ///  <para lang="en">Gets or sets whether text wrapping is allowed in this column. Default is null.</para>
    /// </summary>
    bool? TextWrap { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 text overflow is ellipsis in this column. 默认为 null.</para>
    ///  <para lang="en">Gets or sets whether text overflow is ellipsis in this column. Default is null.</para>
    /// </summary>
    bool? TextEllipsis { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the header text is allowed to wrap. 默认为 false.</para>
    ///  <para lang="en">Gets or sets whether the header text is allowed to wrap. Default is false.</para>
    /// </summary>
    bool HeaderTextWrap { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the header shows a tooltip. 默认为 false. Can be used with <see cref="HeaderTextEllipsis"/>. This parameter is not effective when <see cref="HeaderTextWrap"/> is set to true.</para>
    ///  <para lang="en">Gets or sets whether the header shows a tooltip. Default is false. Can be used with <see cref="HeaderTextEllipsis"/>. This parameter is not effective when <see cref="HeaderTextWrap"/> is set to true.</para>
    /// </summary>
    bool ShowHeaderTooltip { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 the header tooltip 内容.</para>
    ///  <para lang="en">Gets or sets the header tooltip content.</para>
    /// </summary>
    string? HeaderTextTooltip { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the header text is truncated when overflowing. 默认为 false. Can be used with <see cref="HeaderTextTooltip"/>. This parameter is not effective when <see cref="HeaderTextWrap"/> is set to true.</para>
    ///  <para lang="en">Gets or sets whether the header text is truncated when overflowing. Default is false. Can be used with <see cref="HeaderTextTooltip"/>. This parameter is not effective when <see cref="HeaderTextWrap"/> is set to true.</para>
    /// </summary>
    bool HeaderTextEllipsis { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 the custom CSS class for the column td. 默认为 null.</para>
    ///  <para lang="en">Gets or sets the custom CSS class for the column td. Default is null.</para>
    /// </summary>
    string? CssClass { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 the breakpoint at which the column is shown. 默认为 BreakPoint.None.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 the custom tooltip 内容 回调 委托. 默认为 null, using the current value.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the column is required when editing an item. 默认为 null.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the column is read-only when adding a new item. 默认为 null, using the <see cref="IEditorItem.Readonly"/> value.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the column is read-only when editing an item. 默认为 null, using the <see cref="IEditorItem.Readonly"/> value.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the current edit item is visible. 默认为 null, using true value.</para>
    ///  <para lang="en">Gets or sets whether the current edit item is visible. Default is null, using true value.</para>
    /// </summary>
    bool? Visible { get; set; }

    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the column is visible when adding a new item. 默认为 null, using the <see cref="Visible"/> value.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 是否 the column is visible when editing an item. 默认为 null, using the <see cref="Visible"/> value.</para>
    ...
    /// <summary>
    ///  <para lang="zh">获得/设置 the custom search logic.</para>
