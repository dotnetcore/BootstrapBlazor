...
{
    /// <summary>
    /// <para lang="zh">获得/设置 a value indicating 是否 automatic search functionality is enabled. 默认 value is false.
    ///</para>
    /// <para lang="en">Gets or sets a value indicating whether automatic search functionality is enabled. Default value is false.
    ///</para>
    ...
    ///// <summary>
    /// <para lang="zh">获得/设置 行 Key 回调方法
    /////</para>
    /// <para lang="en">Gets or sets 行 Key callback method
    /////</para>
    /// </summary>
    //[Parameter]
    ...
    /// <summary>
    /// <para lang="zh">明细行集合用于数据懒加载
    ///</para>
    /// <para lang="en">明细行collection用于data懒加载
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">Reset all Columns Filter
    ///</para>
    /// <para lang="en">Reset all Columns Filter
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">Reset all Columns Sort
    ///</para>
    /// <para lang="en">Reset all Columns Sort
    ///</para>
    /// </summary>
