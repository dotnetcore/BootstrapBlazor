...
public class TableEditDrawerOption<TModel> : ITableEditDialogOption<TModel>
{
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 保存按钮图标，默认为 null 使用当前主题图标</para>
    /// <para lang="en">Gets or sets save button icon. Default is null (use current theme icon)</para>
    /// </summary>
    ...
    /// <para lang="en">Gets edit items collection</para>
    /// </summary>
