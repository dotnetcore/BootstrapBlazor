...
{
    /// <summary>
    /// <para lang="zh">获得/设置 相关过滤器
    ///</para>
    /// <para lang="en">Gets or sets 相关过滤器
    ///</para>
    /// </summary>
    public IFilter? Filter { get; set; }

    /// <summary>
    /// <para lang="zh">获得/设置 组件类型 默认为 null
    ///</para>
    /// <para lang="en">Gets or sets componenttype Default is为 null
    ///</para>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 组件自定义类型参数集合 默认为 null
    ///</para>
    /// <para lang="en">Gets or sets component自定义type参数collection Default is为 null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 绑定列类型
    ///</para>
    /// <para lang="en">Gets or sets 绑定列type
    ///</para>
    /// </summary>
    [NotNull]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 数据绑定字段值
    ///</para>
    /// <para lang="en">Gets or sets data绑定字段值
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 ValueExpression 表达式
    ///</para>
    /// <para lang="en">Gets or sets ValueExpression 表达式
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否为默认排序列 默认为 false
    ///</para>
    /// <para lang="en">Gets or sets whether为Default is排序列 Default is为 false
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否表头允许折行 默认 false 不折行
    ///</para>
    /// <para lang="en">Gets or sets whether表头允许折行 Default is false 不折行
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否表头显示 Tooltip 默认 false 不显示 可配合 <see cref="HeaderTextEllipsis"/> 使用 设置 <see cref="HeaderTextWrap"/> 为 true 时本参数不生效
    ///</para>
    /// <para lang="en">Gets or sets whether表头display Tooltip Default is false 不display 可配合 <see cref="HeaderTextEllipsis"/> 使用 Sets <see cref="HeaderTextWrap"/> 为 true 时本参数不生效
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否表头 Tooltip 内容
    ///</para>
    /// <para lang="en">Gets or sets whether表头 Tooltip content
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否表头溢出时截断 默认 false 不截断 可配合 <see cref="HeaderTextTooltip"/> 使用 设置 <see cref="HeaderTextWrap"/> 为 true 时本参数不生效
    ///</para>
    /// <para lang="en">Gets or sets whether表头溢出时截断 Default is false 不截断 可配合 <see cref="HeaderTextTooltip"/> 使用 Sets <see cref="HeaderTextWrap"/> 为 true 时本参数不生效
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 表头显示文字
    ///</para>
    /// <para lang="en">Gets or sets 表头display文字
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 placeholder 文本 默认为 null
    ///</para>
    /// <para lang="en">Gets or sets placeholder 文本 Default is为 null
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 列宽 默认为 auto
    ///</para>
    /// <para lang="en">Gets or sets 列宽 Default is为 auto
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否固定本列 默认 false 不固定
    ///</para>
    /// <para lang="en">Gets or sets whether固定本列 Default is false 不固定
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 字段鼠标悬停提示
    ///</para>
    /// <para lang="en">Gets or sets 字段鼠标悬停提示
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 列 td 自定义样式 默认为 null 未设置
    ///</para>
    /// <para lang="en">Gets or sets 列 td 自定义style Default is为 null 未Sets
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 格式化字符串 如时间类型设置 yyyy-MM-dd
    ///</para>
    /// <para lang="en">Gets or sets 格式化字符串 如时间typeSets yyyy-MM-dd
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
