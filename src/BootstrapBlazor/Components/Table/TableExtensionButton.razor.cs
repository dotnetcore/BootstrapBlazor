...
/// <para lang="en">TableExtensionButton 表格扩展button类</para>
/// </summary>
[JSModuleNotInherited]
public partial class TableExtensionButton
{
    /// <summary>
    /// <para lang="zh">获得 Toolbar 扩展按钮集合</para>
    /// <para lang="en">Gets Toolbar 扩展buttoncollection</para>
    /// </summary>
    ...
    /// <para lang="en">Gets or sets 扩展button点击callback method</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <para lang="en">从工具栏中移除button</para>
    /// </summary>
