...
/// <summary>
/// <para lang="zh">Table Toolbar 组件
///</para>
/// <para lang="en">Table Toolbar component
///</para>
/// </summary>
...
{
    /// <summary>
    /// <para lang="zh">获得 Toolbar 按钮集合
    ///</para>
    /// <para lang="en">Gets Toolbar buttoncollection
    ///</para>
    /// </summary>
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 按钮点击后回调委托
    ///</para>
    /// <para lang="en">Gets or sets button点击后回调delegate
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 是否自动收缩工具栏按钮 默认 true
    ///</para>
    /// <para lang="en">Gets or sets whether自动收缩工具栏button Default is true
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 工具栏按钮收缩后是否继承原先按钮的颜色样式 默认 false
    ///</para>
    /// <para lang="en">Gets or sets 工具栏button收缩后whether继承原先button的colorstyle Default is false
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">获得/设置 移动端按钮图标
    ///</para>
    /// <para lang="en">Gets or sets 移动端buttonicon
    ///</para>
    /// <para><version>10.2.2</version></para>
    /// </summary>
    [Parameter]
    ...
    /// <summary>
    /// <para lang="zh">移除按钮到工具栏方法
    ///</para>
    /// <para lang="en">移除button到工具栏方法
    ///</para>
    /// </summary>
