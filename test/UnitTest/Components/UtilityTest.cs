...
namespace UnitTest.Components
{
    ...
    public class UtilityTest
    {
        ...
        public UtilityTest(TestWebHost host)
        {
            Configuration = host.Services.GetRequiredService<IConfiguration>();
            Localizer = host.Services.GetRequiredService<IStringLocalizer<Foo>>();
        }
        ...
        public void GetDisplayName_Ok()
        {
            ...
            //ctx.Services.AddSingleton<IConfiguration>(sp => Configuration);
            //ctx.Services.AddWebSiteServices();
            //ctx.Services.AddBootstrapBlazor();
            //var cut = ctx.RenderComponent<Table<DynamicObject>>(new ComponentParameter[]
            //{
            //    ComponentParameter.CreateParameter("DynamicContext", context)
            //});

            //var finds = cut.FindAll("thead .table-cell");
        }
        ...
        public void GetPropertyValue_Ok()
        {
            ...
            var v2 = Utility.GetPropertyValue<object, object>((object)foo, nameof(Foo.Name));
