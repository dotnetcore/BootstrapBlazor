...
[Collection("PopoverTestContext")]
public class PopoverTestBase
{
    protected TestContext Context { get; }

    public PopoverTestBase()
    {
        Context = PopoverTestHost.Instance;
    }
}

[CollectionDefinition("PopoverTestContext")]
public class PopoverTestCollection : ICollectionFixture<PopoverTestHost>
{

}

public class PopoverTestHost : IDisposable
{
    [NotNull]
    internal static TestContext? Instance { get; private set; }

    public PopoverTestHost()
    {
